...
## Core Capabilities
- **Unified Orchestration:** A single, consistent interface (`prompter.py`) for querying multiple AI providers with standardized input/output logic.
...
### Basic Prompting (Gemini Example)
```bash
cd gemini-cli
